 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --font Montserrat-Bold.ttf --symbols 0123456789:- --size 120 --format lvgl --bpp 4 --no-compress --lv-include lvgl.h --lv-font-name montserrat_bold_120 --output montserrat_bold_120.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x4, 0x67, 0x65, 0x20, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x4b, 0xff, 0xff, 0xff, 0xfe,
    0x81, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2c, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0x70, 0x0, 0x0,
    0x0, 0x4, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 741, .box_w = 35, .box_h = 16, .ofs_x = 6, .ofs_y = 26},
    {.bitmap_index = 280, .adv_w = 1304, .box_w = 73, .box_h = 88, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 3492, .adv_w = 753, .box_w = 38, .box_h = 85, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5107, .adv_w = 1133, .box_w = 68, .box_h = 86, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 8031, .adv_w = 1137, .box_w = 68, .box_h = 86, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 10955, .adv_w = 1323, .box_w = 79, .box_h = 85, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 14313, .adv_w = 1142, .box_w = 68, .box_h = 86, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 17237, .adv_w = 1223, .box_w = 71, .box_h = 88, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 20361, .adv_w = 1190, .box_w = 68, .box_h = 85, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 23251, .adv_w = 1267, .box_w = 71, .box_h = 88, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 26375, .adv_w = 1223, .box_w = 70, .box_h = 88, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 29455, .adv_w = 503, .box_w = 24, .box_h = 67, .ofs_x = 4, .ofs_y = -1}
};
